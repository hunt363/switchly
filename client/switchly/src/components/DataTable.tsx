...
const DataTable: React.FunctionComponent<IDataTableProps> = (
  ...
  const renderTableData = () => {
    return data.map((item) => {
      return (
        <tr key={item._id} className="bg-cat-crust/40">
          ...
          <td className="py-3 flex">
            ...
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 text-cat-blue"
              >
                <path
                  strokeLinecap="round"
            ...
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 text-cat-red"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
  ...
  return (
    <div className="container mx-auto pt-2 pb-10">
      <div className="relative overflow-x-auto shadow-sm sm:rounded-lg ">
        <table className="w-full table-fixed text-sm text-left rtl:text-right text-cat-text">
          <thead className="text-md uppercase text-cat-lavender bg-cat-crust">
            <tr>
